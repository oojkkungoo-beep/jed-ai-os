...
license: MIT
source: "https://github.com/agamm/claude-code-owasp/tree/main/.claude/skills/owasp-security (ติดตั้งผ่าน Vera 2026-07-03 ตามคำขอ Jed — pure instruction-text, read-only tools, ตรวจ SKILL.md + reference/*.md ครบไม่มี script/exfiltration)"
---
