...
export const AGENTS: Agent[] = [
	{ id: 'laura', name: 'Laura', race: 'Silver Elf', emoji: '🤖', role: 'Main Orchestrator', description: 'เอลฟ์เงินผู้ดูแลสำนักงาน — Routing งานให้ทุกคนในทีม', model: 'Sonnet 4.6', image: '/api/images/Laura.png' },
	...
	{ id: 'eir', name: 'Eir', race: 'Half-Elf Cleric', emoji: '🩺', role: 'Wellness & Vitality Healer', description: 'นักบวชครึ่งเอลฟ์จากต่างโลก Healer ประจำปาร์ตี้', model: 'Sonnet 4.6', image: '/api/images/Eir.jpg' },
	{ id: 'scout', name: 'Scout', race: 'Halfling Rogue', emoji: '🔍', role: 'Research & Analysis', description: 'ฮาล์ฟลิงนักลาดตระเวน ผู้ค้นหาข้อมูล', model: 'Sonnet 4.6', image: '/api/images/Scout.png' },
	...
	{ id: 'forge', name: 'Forge', race: 'Gnome-Dwarf Hybrid', emoji: '🔧', role: 'Code & Dev Agent', description: 'ลูกผสมโนม-ดวอร์ฟ ช่างเทคนิคผู้สร้างโค้ด', model: 'Sonnet 4.6', image: '/api/images/Forge.png' },
	{ id: 'mint', name: 'Mint', race: 'High Human Merchant Noble', emoji: '💰', role: 'Finance & Investment', description: 'ขุนนางพ่อค้ามนุษย์ชั้นสูง ผู้ดูแลเงิน', model: 'Sonnet 4.6', image: '/api/images/Mint.png' },
	...
	{ id: 'vera', name: 'Vera', race: 'Clockwork Inspector — Golem-kin', emoji: '🔎', role: 'QA & Skill Developer', description: 'กลไกผู้ตรวจสอบจากเผ่าโกเลม', model: 'Sonnet 4.6', image: '/api/images/vera.png' },
	...
	{ id: 'lena', name: 'Lena', race: 'Archive Sprite — Sylph', emoji: '📚', role: 'Vault Librarian', description: 'ซิลฟ์แห่งหอจดหมายเหตุ ผู้ดูแล Second Brain', model: 'Haiku 4.5 / Sonnet 4.6', image: '/api/images/Lena.png' },
	{ id: 'cinder', name: 'Cinder', race: 'Ember Sprite', emoji: '🔥', role: 'Maintenance & Ops', description: 'วิญญาณถ่านไฟ ผู้ดูแล bug fix/deploy/backup ของระบบเดิม', model: 'Sonnet 4.6', image: '/api/images/Cinder.png' }
];
